...
<body class="fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
	...
	<section>
        ...
        <div class="page-content">
          <div class="header">
            <h2>Status <strong>Table</strong></h2>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3>
                  	<i class="fa fa-table" style="font-size: 20px"></i> <strong style="font-size: 20px">List Status of Vehicles</strong> 
                ...
                <div class="panel-content">
                  <div class="filter-left" style="overflow-x:auto; ">
                    ...
                    <table>
                      ...
                      <tbody>
                        <c:forEach items="${sessionScope.busted}" var="i" >
                        	<tr>
	                          ...
	                          <td class='hidden-480'>${i.status }</td>
	                        </tr> 
	                    </c:forEach>
                      ...
                      <tbody>
                        <c:forEach items="${sessionScope.busted}" var="i" >
                        	<tr>
	                          ...
	                          <td class='hidden-480'>${i.asset_Category}</td>
	                          <td class='hidden-480'>
	                          	<button type="button" class="btn btn-white" style="color:#c75757;">${i.status }</button>
	                          	<%-- <button type="button" class="btn btn-danger btn-rounded">${i.status }</button> --%>
	                          </td>
	                        </tr> 
	                    </c:forEach>
	                    <c:forEach items="${sessionScope.alldata}" var="i" >
                        	<tr>
	                          ...
	                          <td class='hidden-480'>${i.asset_Category}</td>
	                          <td class='hidden-480'>
	                          	<button type="button" class="btn btn-white" style="color:#2c8ca1;">${i.status }</button>
	                          	<%-- <button type="button" class="btn btn-primary btn-rounded">${i.status }</button> --%>
	                          </td>
	                        </tr> 
	                    </c:forEach>
                      </tbody>
