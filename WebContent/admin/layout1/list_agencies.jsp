            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3>
                  	<i class="fa fa-table" style="font-size: 20px"></i> <strong style="font-size: 20px">List of Agencies</strong> 
                    ...
                    <table class="table table-dynamic table-tools">
                      ...
                      <tbody>
                        <c:forEach items="${sessionScope.list}" var="i">
	                        <tr>
	                          <th>${i.a_name}</th>
	                          <th style="text-transform: inherit;">${i.u_name}</th>
	                          <th style="text-transform: inherit;">${i.p_name}</th>
	                        </tr>
                        </c:forEach>
