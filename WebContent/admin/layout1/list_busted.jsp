...
<body class="fixed-topbar fixed-sidebar theme-sdtl color-default dashboard">
	...
	<section>
        ...
        <div class="page-content">
          <div class="header">
            <h2> Busted<strong> Vehicles</strong></h2>
            <!-- <div class="breadcrumb-wrapper">
              <ol class="breadcrumb">
                ...
                <li class="active"><i class="fa fa-table" style="font-size: 20px"></i> Busted Vehicles</li>
              </ol>
            </div> -->
          </div>
            ...
            <div class="col-lg-12 portlets">
              <div class="panel">
                <div class="panel-header panel-controls">
                  <h3>
                  	<i class="fa fa-table" style="font-size: 20px"></i> <strong style="font-size: 20px">List of Busted Vehicles</strong>  
                      ...
                      <tbody>
                        <c:forEach items="${sessionScope.busted}" var="i" >
                        	<tr>
	                          ...
	                          <td class='hidden-480'>${i.asset_Category}</td>
	                          <td class='hidden-480'>
	                          	<a href="<%=request.getContextPath() %>/Login?flag=undo&regno=<c:out value="${i.reg_No }"/>">
	                          		<button type="button" class="btn btn-primary btn-rounded">Undo</button>
	                          	</a>
	                          </td>
	                        </tr> 
